...
export default class ManagerEmployeeList extends Component {
  constructor(props) {
    super(props);
    this.state = { user: [] };
  }
  ...
  render() {
    return (
      <div>
        {" "}
        <h1 className="text-center display-1 mt-5">Çalışanlar</h1>
        <div className="d-flex justify-content-around align-items-center mt-5 mb-3">
          ...
          <a href="/addEmployee" className="btn btn-lg btn-warning ">
            Çalışan Ekle
          </a>
        </div>
